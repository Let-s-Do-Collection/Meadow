...
public class TabRegistry {
    ...
    public static final RegistrySupplier<CreativeModeTab> MEADOW_TAB = CREATIVE_MODE_TABS.register("meadow", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
            ...
            .displayItems((parameters, out) -> {
                ...
                out.accept(new ItemStack(ObjectRegistry.PINE_SIGN_ITEM.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_HANGING_SIGN_ITEM.get()));
                ...
                out.accept(new ItemStack(ObjectRegistry.PINE_WINDOW_PANE.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_SAPLING.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_LEAVES.get()));
                out.accept(new ItemStack(ObjectRegistry.YELLOW_PINE_SAPLING.get()));
                out.accept(new ItemStack(ObjectRegistry.YELLOW_PINE_LEAVES.get()));
                out.accept(new ItemStack(ObjectRegistry.ALPINE_BIRCH_SAPLING.get()));
                out.accept(new ItemStack(ObjectRegistry.ALPINE_BIRCH_LOG.get()));
                out.accept(new ItemStack(ObjectRegistry.ALPINE_BIRCH_LEAVES.get()));
                ...
                out.accept(new ItemStack(ObjectRegistry.PINE_CHEESE_RACK.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_SOFA.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_DRESSER.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_CABINET.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_WALL_CABINET.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_WARDROBE.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_CHAIR.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_TABLE.get()));
                out.accept(new ItemStack(ObjectRegistry.PINE_BENCH.get()));
                ...
                out.accept(new ItemStack(ObjectRegistry.ARTISAN_GLASS_WINDOW.get()));
                out.accept(new ItemStack(ObjectRegistry.ARTISAN_GLASS_WINDOW_PANE.get()));
                out.accept(new ItemStack(ObjectRegistry.ORNATE_GLASS_WINDOW.get()));
                out.accept(new ItemStack(ObjectRegistry.ORNATE_GLASS_WINDOW_PANE.get()));
                ...
                out.accept(new ItemStack(ObjectRegistry.FIREWOOD.get()));
                out.accept(new ItemStack(ObjectRegistry.MILK_CAN.get()));
                out.accept(new ItemStack(ObjectRegistry.FELTING_NEEDLE.get()));
                out.accept(new ItemStack(ObjectRegistry.WATERING_CAN_ITEM.get()));
                ...
                out.accept(new ItemStack(ObjectRegistry.TALL_ERIOPHORUM.get()));
                ...
                out.accept(new ItemStack(ObjectRegistry.LINEN.get()));
