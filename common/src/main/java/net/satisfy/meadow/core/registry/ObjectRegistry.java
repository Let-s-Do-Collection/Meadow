...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> RECLAIMED_PINE_PLANKS = registerWithItem("reclaimed_pine_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    public static final RegistrySupplier<Block> RECLAIMED_PINE_STAIRS = registerWithItem("reclaimed_pine_stairs", () -> new StairBlock(RECLAIMED_PINE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(PINE_PLANKS.get())));
    public static final RegistrySupplier<Block> RECLAIMED_PINE_SLAB = registerWithItem("reclaimed_pine_slab", () -> new SlabBlock(getSlabSettings()));
    ...
    public static final RegistrySupplier<Block> RECLAIMED_PINE_TRAPDOOR = registerWithItem("reclaimed_pine_trapdoor", () -> new TrapDoorBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_TRAPDOOR)));
    public static final RegistrySupplier<Block> RECLAIMED_PINE_DOOR = registerWithItem("reclaimed_pine_door", () -> new DoorBlock(BlockSetType.OAK, BlockBehaviour.Properties.of().strength(3.0f).sound(SoundType.WOOD).noOcclusion().mapColor(PINE_PLANKS.get().defaultMapColor())));
    ...
    public static final RegistrySupplier<Block> PINE_SOFA_RUSTIC = registerWithItem("pine_sofa_rustic", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_BROWN)));
    public static final RegistrySupplier<Block> PINE_SOFA_LINEN = registerWithItem("pine_sofa_linen", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_GRAY)));
    public static final RegistrySupplier<Block> PINE_SOFA_JACQUARD = registerWithItem("pine_sofa_jacquard", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_BLUE)));
    public static final RegistrySupplier<Block> PINE_SOFA_PLAID = registerWithItem("pine_sofa_plaid", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_GRAY)));
    public static final RegistrySupplier<Block> PINE_SOFA_CHAMBRAY = registerWithItem("pine_sofa_chambray", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_BLUE)));
    public static final RegistrySupplier<Block> PINE_SOFA_TWEED = registerWithItem("pine_sofa_tweed", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_BLACK)));
    public static final RegistrySupplier<Block> PINE_SOFA_WARPED = registerWithItem("pine_sofa_warped", () -> new SofaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).mapColor(MapColor.COLOR_CYAN)));
    ...
    public static final RegistrySupplier<Block> PINE_SHUTTER = registerWithItem("pine_shutter", () -> new ShutterBlock(BlockBehaviour.Properties.of().strength(1.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistrySupplier<Block> RUSTIC_BED = registerWithItem("rustic_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    public static final RegistrySupplier<Block> LINEN = registerWithItem("linen", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_WOOL)));
    public static final RegistrySupplier<Block> LINEN_CARPET = registerWithItem("linen_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_CARPET)));
    public static final RegistrySupplier<Block> LINEN_BED = registerWithItem("linen_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    public static final RegistrySupplier<Block> JACQUARD_WOOL = registerWithItem("jacquard_wool", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_WOOL)));
    public static final RegistrySupplier<Block> JACQUARD_CARPET = registerWithItem("jacquard_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_CARPET)));
    public static final RegistrySupplier<Block> JACQUARD_BED = registerWithItem("jacquard_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    public static final RegistrySupplier<Block> PLAID_WOOL = registerWithItem("plaid_wool", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_WOOL)));
    public static final RegistrySupplier<Block> PLAID_CARPET = registerWithItem("plaid_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_CARPET)));
    public static final RegistrySupplier<Block> PLAID_BED = registerWithItem("plaid_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    public static final RegistrySupplier<Block> CHAMBRAY_WOOL = registerWithItem("chambray_wool", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_WOOL)));
    public static final RegistrySupplier<Block> CHAMBRAY_CARPET = registerWithItem("chambray_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_CARPET)));
    public static final RegistrySupplier<Block> CHAMBRAY_BED = registerWithItem("chambray_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    public static final RegistrySupplier<Block> TWEED_WOOL = registerWithItem("tweed_wool", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_WOOL)));
    public static final RegistrySupplier<Block> TWEED_CARPET = registerWithItem("tweed_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_CARPET)));
    public static final RegistrySupplier<Block> TWEED_BED = registerWithItem("tweed_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    ...
    public static final RegistrySupplier<Block> WARPED_BED = registerWithItem("warped_bed", () -> new MeadowBedBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOD).strength(0.2F).noOcclusion()));
    ...
    public static final RegistrySupplier<Block> COOKING_CAULDRON = registerWithItem("cookpot", () -> new CookingCauldronBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.5F).sound(SoundType.METAL)));
    public static final RegistrySupplier<Block> COOKING_FRAME = registerWithItem("cooking_frame", () -> new CookingFrameBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().lightLevel((blockState) -> 13).strength(3.5F).sound(SoundType.WOOD).noOcclusion()));
    ...
    public static final RegistrySupplier<Block> CLIMBING_ROPE = registerWithItem("climbing_rope", () -> new ClimbingRopeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_WOOL).noCollission()));
    ...
    public static final RegistrySupplier<Item> FUR_HELMET = registerItem("fur_helmet", () -> new FurHelmetItem(BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(ArmorMaterialRegistry.FUR_ARMOR), ArmorItem.Type.HELMET, getSettings().rarity(Rarity.EPIC).durability(ArmorItem.Type.HELMET.getDurability(15)).stacksTo(1), Meadow.identifier("textures/models/armor/fur.png")));
    public static final RegistrySupplier<Item> FUR_CHESTPLATE = registerItem("fur_chestplate", () -> new FurChestItem(BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(ArmorMaterialRegistry.FUR_ARMOR), ArmorItem.Type.CHESTPLATE, getSettings().rarity(Rarity.RARE).durability(ArmorItem.Type.CHESTPLATE.getDurability(15)).stacksTo(1), Meadow.identifier("textures/models/armor/fur.png")));
    public static final RegistrySupplier<Item> FUR_LEGGINGS = registerItem("fur_leggings", () -> new FurLegsItem(BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(ArmorMaterialRegistry.FUR_ARMOR), ArmorItem.Type.LEGGINGS, getSettings().rarity(Rarity.RARE).durability(ArmorItem.Type.LEGGINGS.getDurability(15)).stacksTo(1), Meadow.identifier("textures/models/armor/fur.png")));
    public static final RegistrySupplier<Item> FUR_BOOTS = registerItem("fur_boots", () -> new FurBootsItem(BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(ArmorMaterialRegistry.FUR_ARMOR), ArmorItem.Type.BOOTS, getSettings().rarity(Rarity.RARE).durability(ArmorItem.Type.BOOTS.getDurability(15)).stacksTo(1), Meadow.identifier("textures/models/armor/fur.png")));
    ...
    public static final RegistrySupplier<Item> WARPED_CHEESE_SLICE = registerItem("warped_cheese_slice", () -> new Item(getSettings().food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.8f).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 300, 1), 1.0F).build())));
    public static final RegistrySupplier<Block> CHEESECAKE = registerWithItem("cheesecake", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.CHEESECAKE_SLICE, CheeseWheelBlock.CheeseType.CHEESECAKE));
    public static final RegistrySupplier<Block> CHEESE_TART = registerWithItem("cheese_tart", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.CHEESE_TART_SLICE, CheeseWheelBlock.CheeseType.CHEESE_TART));
    public static final RegistrySupplier<Block> CHEESE_WHEEL = registerWithItem("cheese_wheel", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.CHEESE_SLICE, CheeseWheelBlock.CheeseType.REGULAR));
    public static final RegistrySupplier<Block> AMETHYST_CHEESE_WHEEL = registerWithItem("amethyst_cheese_wheel", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.AMETHYST_CHEESE_SLICE, CheeseWheelBlock.CheeseType.REGULAR));
    public static final RegistrySupplier<Block> BUFFALO_CHEESE_WHEEL = registerWithItem("buffalo_cheese_wheel", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.BUFFALO_CHEESE_SLICE, CheeseWheelBlock.CheeseType.BUFFALO));
    public static final RegistrySupplier<Block> WARPED_CHEESE_WHEEL = registerWithItem("warped_cheese_wheel", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.WARPED_CHEESE_SLICE, CheeseWheelBlock.CheeseType.WARPED));
    public static final RegistrySupplier<Block> GRAIN_CHEESE_WHEEL = registerWithItem("grain_cheese_wheel", () -> new CheeseWheelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), ObjectRegistry.GRAIN_CHEESE_SLICE, CheeseWheelBlock.CheeseType.GRAIN));
    ...
    public static final RegistrySupplier<Block> ROASTED_BUFFALO_HAM = registerWithItem("roasted_buffalo_ham", () -> new FoodBlock(Block.Properties.of(), new MobEffectInstance(MobEffects.REGENERATION, 600, 1), 8, 0.9f));
    ...
    public static final RegistrySupplier<Block> POTTED_YELLOW_PINE_SAPLING = registerWithoutItem("potted_yellow_pine_sapling", () -> new FlowerPotBlock(ObjectRegistry.YELLOW_PINE_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_ALPINE_BIRCH_SAPLING = registerWithoutItem("potted_alpine_birch_sapling", () -> new FlowerPotBlock(ObjectRegistry.ALPINE_BIRCH_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    ...
    public static final RegistrySupplier<Block> PINE_SIGN = registerWithoutItem("pine_sign", () -> new PineStandingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN), MeadowWoodType.PINE));
    public static final RegistrySupplier<Block> PINE_WALL_SIGN = registerWithoutItem("pine_wall_sign", () -> new PineWallSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN), MeadowWoodType.PINE));
    public static final RegistrySupplier<Block> PINE_HANGING_SIGN = registerWithoutItem("pine_hanging_sign", () -> new PineCeilingHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN), MeadowWoodType.PINE));
