...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<CompletionistBannerBlockEntity>> MEADOW_BANNER = registerBlockEntity("meadow_banner", () -> BlockEntityType.Builder.of(CompletionistBannerBlockEntity::new, ObjectRegistry.MEADOW_BANNER.get(), ObjectRegistry.MEADOW_WALL_BANNER.get()).build(null));
