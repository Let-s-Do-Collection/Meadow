package net.satisfy.meadow.neoforge.core.event;
...
import net.satisfy.meadow.neoforge.core.registry.MeadowNeoforgeVillagers;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class MeadowNeoforgeEventhandler {

    @Mod.EventBusSubscriber(modid = Meadow.MOD_ID)
    public static class ForgeEvents {
        @SubscribeEvent
        public static void addCustomTrades(VillagerTradesEvent event) {
            if (event.getType().equals(MeadowNeoforgeVillagers.CHEESEMAKER.get())) {
            ...
            } else if (event.getType().equals(MeadowNeoforgeVillagers.HERMIT.get())) {
                Map<Integer, List<VillagerTrades.ItemListing>> trades = new HashMap<>(event.getTrades());
