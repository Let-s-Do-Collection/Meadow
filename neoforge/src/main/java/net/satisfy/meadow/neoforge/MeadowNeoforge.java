...
public class MeadowNeoforge {
    public MeadowNeoforge() {
        ...
        MeadowNeoforgeVillagers.register(modEventBus);
        modEventBus.addListener(this::commonSetup);
        MeadowNeoforgeConfig.loadConfig(MeadowNeoforgeConfig.COMMON_CONFIG, FMLPaths.CONFIGDIR.get().resolve("meadow.toml").toString());
